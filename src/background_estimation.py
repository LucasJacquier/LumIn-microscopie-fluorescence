...
img_init = load_data(
    "C:/Users/lucas/Documents/sciences/Mes Recherches/2022_09 ARIA 1er Stage/Films/A6_0831_8RRL.tif",
    "[R,D]",
)["R"][10]
...
def background_elimination_substract(
    initial_frame: np.ndarray, averaged_frame: np.ndarray
) -> np.ndarray:
